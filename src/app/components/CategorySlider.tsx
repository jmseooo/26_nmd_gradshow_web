          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-start" style={{ gap: "clamp(4px, 0.56vw, 8px)" }}>
                <p className="whitespace-nowrap" style={txt(16, 600, "black")}>참여자, {cat.memberCount}명</p>
              </div>
            </div>
            ...
            {/* 오른쪽: 교수님 */}
            <div style={{ padding: "0 clamp(16px, 3.33vw, 48px)" }}>
              <p className="whitespace-nowrap" style={txt(16, 400, "black")}>{cat.professor} 교수님</p>
            </div>
          </div>
        </div>
